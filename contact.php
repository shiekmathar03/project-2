...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">11,sedan kaathi Street,rajapalayam</span> <br>
										<span class="text-white">rajapalayam</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 9345678910</span>
										<span class="text-white">+91 843765432 </span>
									</div>
                                </li>
        ...
        <!--	Map -->
		<iframe width="648" height="493" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=648&amp;height=493&amp;hl=en&amp;q=anjana%20infotech%20rajapalayam+(rajapalayam)&amp;t=k&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='https://www.versicherungen.at/cyber-versicherung/'>Hackerversicherung</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=4406e667c3d0e6375888f21d59365bdf66a423c7'></script>
		<!--	Map -->
